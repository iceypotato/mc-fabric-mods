...
class CubeRenderer(context: EntityRendererFactory.Context) : MobEntityRenderer<Cube, CubeEntityModel>(context, CubeEntityModel(context.getPart(LigmaEntMdlLyrs.cube)), 0.5f) {
