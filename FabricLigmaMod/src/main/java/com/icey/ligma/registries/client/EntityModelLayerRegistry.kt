...
object LigmaEntMdlLyrs {
    ...
    val justinw = EntityModelLayer(Identifier(LigmaMain.MODID, "justinw"), "justinw")
}
...
fun registerEntityModelLayers() {
    ...
    EntityModelLayerRegistry.registerModelLayer(LigmaEntMdlLyrs.justinw) { JustinwEntityModel.getTexturedModelData() }
}