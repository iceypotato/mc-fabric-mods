...
var manScreamingSoundIdentifier = Identifier(LigmaModMain.MODID, "manscream")
var manScreamingSoundEvent = SoundEvent(manScreamingSoundIdentifier)
fun registerSounds() {
    ...
    Registry.register(Registry.SOUND_EVENT, manScreamingSoundIdentifier, manScreamingSoundEvent)
}