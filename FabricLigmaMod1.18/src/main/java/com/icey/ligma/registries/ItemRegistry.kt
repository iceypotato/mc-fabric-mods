...
var tanaysFuckingFace = TanaysFuckingFace(ligmaToolMaterial, Int.MAX_VALUE, 100F, Item.Settings().group(ItemGroup.MISC))
...
var minhsHornyFace = MinhsHornyFace(Item.Settings().group(ItemGroup.SEARCH).maxCount(1))
...
fun registerItems() {
    ...
    Registry.register(Registry.ITEM, Identifier(LigmaModMain.MODID, "tanay"), tanaysFuckingFace)
